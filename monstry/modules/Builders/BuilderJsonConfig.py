...
from ..global_data import ENGINE_AVAILABLE, EXTENSION_AVAILABLE
...
class BuilderJsonConfig(Builder, InterfaceGetters):
            ...
            if self.engine in self.ENGINE_AVAILABLE:
                ...
                if self.table is None:
                    ...
                    self.table = re.search(
                        regexp_file_name, self.query_path)[0]

        except Exception as e:
            print(
                f"ERROR producido en la lectura del archivo de configuracion\n\t{e}")
    ...
    def get_query(self, **kwargs):
        ...
        try:
            ...
            print(
                f"ERROR producido en la obtencion de la query desde un archivo\n\t{e}")
